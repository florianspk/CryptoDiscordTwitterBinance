...
# Download the file specified by the URL returned by the API into a pandas dataframe object
df = pd.read_csv(resultsURL)
# Loop through the data from the CSV file
for index, row in df.iterrows():
    # Remove quotes and hashtag symbols from hashtags, and single quotes from other fields
